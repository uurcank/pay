module Pay
  module Shopify
    class Customer < Pay::Customer
      has_many :charges, dependent: :destroy, class_name: "Pay::Shopify::Charge"
      has_many :subscriptions, dependent: :destroy, class_name: "Pay::Shopify::Subscription"
      has_many :payment_methods, dependent: :destroy, class_name: "Pay::Shopify::PaymentMethod"
      has_one :default_payment_method, -> { where(default: true) }, class_name: "Pay::Shopify::PaymentMethod"
